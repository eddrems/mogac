...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            ...
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / Procesos de A.C. / <strong>Requisitos</strong> / Crear</p>
        </header>
                    ...
                    <section class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="bs-example form-horizontal">
                                ...
                                {!! Form::open(array('url' => 'catalogos/procesos_ac/requisitos/grabar_nuevo', 'id' => 'frmMain')) !!}
                                {!! Form::hidden('id_proceso', $proceso->id_proceso) !!}

                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Denominaci&oacute;n:</label>
                                    <div class="col-lg-10">
                                        {!! Form::text('nombre', Input::old('nombre') ? Input::old('nombre') : '', array('class' => 'form-control', 'data-required' => 'true')) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::textarea('observaciones', Input::old('observaciones') ? Input::old('observaciones') : '', array('class' => 'form-control')) !!}
                                    </div>
                                </div>
