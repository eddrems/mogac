...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            ...
            <a href="{{ URL::to('catalogos/ciudades/listar/' . Crypt::encrypt($provincia->id_provincia)) }}" class="btn btn-default btn-sm  pull-right" style="margin-right:5px; "><i class="icon-share-alt icon-black"></i> Regresar</a>
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / <strong>{!! $provincia->denominacion !!}</strong>/ Ciudades / <strong>{!! strtoupper($registro->denominacion) !!}</strong> / Editar </p>
        </header>
                    ...
                    <section class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="bs-example form-horizontal">
                                ...
                                {!! Form::open(array('url' => 'catalogos/ciudades/grabar_actualizar', 'id' => 'frmMain')) !!}

                                {!! Form::hidden('id', Crypt::encrypt($registro->id_ciudad)) !!}
                                {!! Form::hidden('id_provincia',$provincia->id_provincia) !!}
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">C&oacute;digo:</label>
                                    <div class="col-lg-10">
                                        {!! Form::text('codigo', Input::old('codigo') ? Input::old('codigo') : $registro->codigo, array('class' => 'form-control', 'data-required' => 'true', 'autocomplete' => 'off')) !!}
                                    </div>
                                </div>
