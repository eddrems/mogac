...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            <a href="{{ url('catalogos/ciudades/crear/' . Crypt::encrypt($provincia->id_provincia)) }}" class="btn btn-primary btn-sm  pull-right" style="margin-right:5px; " >Nuevo Registro</a>
            ...
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / <strong>{!! $provincia->denominacion !!}</strong>/ Ciudades</p>
        </header>
            ...
            <div class="tab-pane" id="datatable">
                <section class="panel panel-primary">
                    ...
                    <div class="table-responsive">
                        ...
                        ->setUrl(URL::to('catalogos/ciudades/buscar_registros_dt') . '/' . $provincia->id_provincia)
                        ->noScript()
                        ->render('catalogos.lg_ciudades.dt_template')
                        !!}
