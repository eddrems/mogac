...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            ...
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / <strong>{!! $provincia->denominacion !!}</strong>/ Ciudades / Eliminar </p>
        </header>
                    ...
                    <section class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <div class="bs-example form-horizontal">
                                ...
                                {!! Form::open(array('url' => 'catalogos/ciudades/grabar_eliminar', 'id' => 'frmMain')) !!}
                                {!! Form::hidden('id', Crypt::encrypt($registro->id_ciudad)) !!}
                                {!! Form::hidden('id_provincia', Crypt::encrypt($registro->id_provincia)) !!}
