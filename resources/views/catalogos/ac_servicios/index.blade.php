...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            <a href="{{ url('catalogos/servicios_ac/crear') }}" class="btn btn-primary btn-sm  pull-right" style="margin-right:5px; " >Nuevo Registro</a>
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / <strong>Taxonomía - Servicios</strong></p>
        </header>
            ...
            <div class="tab-pane" id="datatable">
                <section class="panel panel-primary">
                    ...
                    <div class="table-responsive">
                        ...
                        ->setUrl(URL::to('catalogos/servicios_ac/buscar_registros_dt'))
                        ->noScript()
                        ->render('catalogos.ac_servicios.dt_template')
                        !!}
