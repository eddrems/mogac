...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            ...
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / <strong>Taxonomía - Servicios</strong> / Eliminar </p>
        </header>
                    ...
                    <section class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <div class="bs-example form-horizontal">
                                ...
                                {!! Form::open(array('url' => 'catalogos/servicios_ac/grabar_eliminar', 'id' => 'frmMain')) !!}
