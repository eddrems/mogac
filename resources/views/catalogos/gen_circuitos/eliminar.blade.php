...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            ...
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / <strong>Circuitos</strong> / Eliminar </p>
        </header>
                    ...
                    <section class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <div class="bs-example form-horizontal">
                                ...
                                {!! Form::open(array('url' => 'catalogos/circuitos/grabar_eliminar', 'id' => 'frmMain')) !!}
                                ...
                                <div class="form-group">
                                    <label class="col-lg-12 ">
                                        <div class="col-lg-12">
                                            ...
                                            <h3 style="margin-top: 0px;"><strong>{!! $registro->codigoSemplades !!}</strong></h3>
                                            <br>
