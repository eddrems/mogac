...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            <a href="{{ url('catalogos/departamentos_funcionarios/crear') }}" class="btn btn-primary btn-sm  pull-right" style="margin-right:5px; " >Nuevo Registro</a>
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / <strong> RRHH - Departamentos (Unidades de Gestión)</strong></p>
        </header>
            ...
            <div class="tab-pane" id="datatable">
                <section class="panel panel-primary">
                    ...
                    <div class="table-responsive">
                        ...
                        {!!
                        Datatable::table()
                        ->addColumn('Denominación', 'ACT', 'NAC', 'ZON', 'DST', 'BLOC', 'MULT', '' )
                        ->setUrl(URL::to('catalogos/departamentos_funcionarios/buscar_registros_dt'))
                        ->noScript()
                        ->render('catalogos.rrhh_departamentos.dt_template')
                        !!}
