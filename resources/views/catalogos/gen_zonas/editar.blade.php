...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            ...
            <a href="{{ URL::to('catalogos/zonas') }}" class="btn btn-default btn-sm  pull-right" style="margin-right:5px; "><i class="icon-share-alt icon-black"></i> Regresar</a>
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / <strong>Zonas</strong> / Editar </p>
        </header>
                    ...
                    <section class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="bs-example form-horizontal">
                                ...
                                {!! Form::open(array('url' => 'catalogos/zonas/grabar_actualizar', 'id' => 'frmMain')) !!}
                                {!! Form::hidden('id', Crypt::encrypt($registro->id_zona)) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('composicion', Input::old('composicion') ? Input::old('composicion') : $registro->composicion, array('class' => 'form-control', 'data-required' => 'true')) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('logo_certificacion', Input::old('logo_certificacion') ? Input::old('logo_certificacion') : $registro->logo_certificacion, array('class' => 'form-control', 'data-required' => 'true')) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('numero_certificacion', Input::old('numero_certificacion') ? Input::old('numero_certificacion') : $registro->numero_certificacion, array('class' => 'form-control', 'data-required' => 'true')) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('pie_pagina_certificacion', Input::old('pie_pagina_certificacion') ? Input::old('pie_pagina_certificacion') : $registro->pie_pagina_certificacion, array('class' => 'form-control', 'data-required' => 'true')) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('logo_top', Input::old('logo_top') ? Input::old('logo_top') : $registro->logo_top, array('class' => 'form-control', 'data-required' => 'true')) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('logo_left', Input::old('logo_left') ? Input::old('logo_left') : $registro->logo_left, array('class' => 'form-control', 'data-required' => 'true')) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('numero_top', Input::old('numero_top') ? Input::old('numero_top') : $registro->numero_top, array('class' => 'form-control', 'data-required' => 'true')) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('numero_width', Input::old('numero_width') ? Input::old('numero_width') : $registro->numero_width, array('class' => 'form-control', 'data-required' => 'true')) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('logo_scale', Input::old('logo_scale') ? Input::old('logo_scale') : $registro->logo_scale, array('class' => 'form-control', 'data-required' => 'true')) !!}
                                    </div>
                                </div>
