...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            ...
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / <strong>Taxonomía - Casos</strong> / Crear</p>
        </header>
                    ...
                    <section class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="bs-example form-horizontal">
                                ...
                                {!! Form::open(array('url' => 'catalogos/casos_ac/grabar_nuevo', 'id' => 'frmMain')) !!}


                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Servicio:</label>
                                    <div class="col-lg-10">
                                        {!! Form::select('id_servicio', $id_servicio, Input::old('id_servicio') ? Input::old('id_servicio') : null, array('class' => 'form-control', 'data-required' => 'true', 'id' => 'id_servicio')) !!}
                                    </div>
                                </div>
