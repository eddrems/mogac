...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            ...
            <a href="{{ URL::to('catalogos/casos_ac') }}" class="btn btn-default btn-sm  pull-right" style="margin-right:5px; "><i class="icon-share-alt icon-black"></i> Regresar</a>
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / <strong>Taxonomía - Casos</strong> / Editar </p>
        </header>
                    ...
                    <section class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="bs-example form-horizontal">
                                ...
                                {!! Form::open(array('url' => 'catalogos/casos_ac/grabar_actualizar', 'id' => 'frmMain')) !!}
                                {!! Form::hidden('id', Crypt::encrypt($registro->id_caso)) !!}

                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Servicio:</label>
                                    <div class="col-lg-10">
                                        {!! Form::select('id_servicio', $id_servicio, Input::old('id_servicio') ? Input::old('id_servicio') : $registro->id_servicio, array('class' => 'form-control', 'data-required' => 'true', 'id' => 'id_servicio')) !!}
                                    </div>
                                </div>
