...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            <a href="{{ url('catalogos/tramites_estado/crear') }}" class="btn btn-primary btn-sm  pull-right" style="margin-right:5px; " >Nuevo Registro</a>
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / <strong>Estados de Trámites (Bandejas)</strong></p>
        </header>
            ...
            <div class="tab-pane" id="datatable">
                <section class="panel panel-primary">
                    ...
                    <div class="table-responsive">
                        ...
                        {!!
                        Datatable::table()
                        ->addColumn('No.', 'Denominación', 'CSS', 'EDT', 'TER', 'CAM', 'TRA', '' )
                        ->setUrl(URL::to('catalogos/tramites_estado/buscar_registros_dt'))
                        ->noScript()
                        ->render('catalogos.ac_tramite_estados.dt_template')
                        !!}
