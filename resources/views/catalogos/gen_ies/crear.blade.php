...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            ...
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / <strong>IEs</strong> / Crear</p>
        </header>
                    ...
                    <section class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="bs-example form-horizontal">
                                ...
                                {!! Form::open(array('url' => 'catalogos/ies/grabar_nuevo', 'id' => 'frmMain')) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('codigo_amie', Input::old('codigo_amie') ? Input::old('codigo_amie') : '', array('class' => 'form-control', 'data-required' => 'true', 'autocomplete' => 'off')) !!}
                                    </div>
                                </div>
...
@section('js_code')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#id_circuito', this).chosen('destroy').chosen();
