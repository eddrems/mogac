...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            ...
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / <strong>{!! $ciudad->provincia->denominacion !!} / {!! $ciudad->denominacion !!}</strong> / Parroquias / Crear</p>
        </header>
                    ...
                    <section class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="bs-example form-horizontal">
                                ...
                                {!! Form::open(array('url' => 'catalogos/parroquias/grabar_nuevo', 'id' => 'frmMain')) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('codigo', Input::old('codigo') ? Input::old('codigo') : '', array('class' => 'form-control', 'data-required' => 'true', 'autocomplete' => 'off')) !!}
                                    </div>
                                </div>
