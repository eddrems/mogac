...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            ...
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / <strong>{!! $ciudad->provincia->denominacion !!} / {!! $ciudad->denominacion !!}</strong> / Parroquias / Eliminar </p>
        </header>
                    ...
                    <section class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <div class="bs-example form-horizontal">
                                ...
                                {!! Form::open(array('url' => 'catalogos/parroquias/grabar_eliminar', 'id' => 'frmMain')) !!}
                                {!! Form::hidden('id', Crypt::encrypt($registro->id_parroquia)) !!}
                                {!! Form::hidden('id_ciudad', Crypt::encrypt($registro->id_ciudad)) !!}
