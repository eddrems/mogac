...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            ...
            <a href="{{ URL::to('catalogos/parroquias/listar/' . Crypt::encrypt($ciudad->id_ciudad)) }}" class="btn btn-default btn-sm  pull-right" style="margin-right:5px; "><i class="icon-share-alt icon-black"></i> Cancelar</a>
            <p style="font-size: medium;"><i class="fa fa-database"></i> Catálogos / <strong>{!! $ciudad->provincia->denominacion !!} / {!! $ciudad->denominacion !!}</strong> / Parroquias / Editar </p>
        </header>
                    ...
                    <section class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="bs-example form-horizontal">
                                ...
                                {!! Form::open(array('url' => 'catalogos/parroquias/grabar_actualizar', 'id' => 'frmMain')) !!}

                                {!! Form::hidden('id', Crypt::encrypt($registro->id_parroquia)) !!}
                                {!! Form::hidden('id_ciudad',$ciudad->id_ciudad) !!}
