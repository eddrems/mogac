...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            <a href="{{ url('seguridades/modulos/crear') }}" class="btn btn-primary btn-sm  pull-right" style="margin-right:5px; " >Nuevo Registro</a>
            <p style="font-size: medium;"><i class="fa fa-unlock"></i> Seguridades / <strong> Módulos del Aplicativo</strong></p>
        </header>
            ...
            <div class="tab-pane" id="datatable">
                <section class="panel panel-primary">
                    ...
                    <div class="table-responsive">
                        ...
                        {!!
                        Datatable::table()
                        ->addColumn('Orden', 'Denominación', 'Activo', 'Icon', '' )
                        ->setUrl(URL::to('seguridades/modulos/buscar_registros_dt'))
                        ->noScript()
                        ->render('seguridades.modulos_agrupacion.dt_template')
                        !!}
