...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            <a href="{{ url('seguridades/roles/permisos/crear') . '/' . Crypt::encrypt($rol->id_rol) }}" class="btn btn-primary btn-sm  pull-right" style="margin-right:5px; " >Nuevo Registro</a>
            ...
            <p style="font-size: medium;"><i class="fa fa-unlock"></i> Seguridades / Rol: <strong> {!! $rol->denominacion !!} </strong> / Permisos</p>
        </header>
            ...
            <div class="tab-pane" id="datatable">
                <section class="panel panel-primary">
                    ...
                    <div class="table-responsive">
                        ...
                        {!!
                        Datatable::table()
                        ->addColumn('Denominación', 'Agrupador', '' )
                        ->setUrl(URL::to('seguridades/roles/permisos/buscar_registros_dt') . '/' . Crypt::encrypt($rol->id_rol))
                        ->noScript()
                        ->render('seguridades.roles_permisos.dt_template')
                        !!}
