...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            <a href="{{ url('seguridades/modulos/detalles/crear') . '/' . Crypt::encrypt($agrupador->id_subsistema) }}" class="btn btn-primary btn-sm  pull-right" style="margin-right:5px; " >Nuevo Registro</a>
            ...
            <p style="font-size: medium;"><i class="fa fa-unlock"></i> Seguridades / <strong> {!! $agrupador->descripcion !!} </strong> / Detalles</p>
        </header>
            ...
            <div class="tab-pane" id="datatable">
                <section class="panel panel-primary">
                    ...
                    <div class="table-responsive">
                        ...
                        {!!
                        Datatable::table()
                        ->addColumn('Denominación', 'Ruta', 'Icon', '' )
                        ->setUrl(URL::to('seguridades/modulos/detalles/buscar_registros_dt') . '/' . Crypt::encrypt($agrupador->id_subsistema))
                        ->noScript()
                        ->render('seguridades.modulos.dt_template')
                        !!}
