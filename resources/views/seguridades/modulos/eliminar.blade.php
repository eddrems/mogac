...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            ...
            <p style="font-size: medium;"><i class="fa fa-unlock"></i> Seguridades / <strong> {!! $agrupador->descripcion !!} </strong> / Detalles / Eliminar </p>
        </header>
                    ...
                    <section class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <div class="bs-example form-horizontal">
                                ...
                                {!! Form::open(array('url' => 'seguridades/modulos/detalles/grabar_eliminar', 'id' => 'frmMain')) !!}
                                {!! Form::hidden('id', Crypt::encrypt($registro->id_modulo)) !!}
                                {!! Form::hidden('id_subsistema', Crypt::encrypt($agrupador->id_subsistema)) !!}
