...
@section('content')
    ...
    <section class="vbox">
        <header class="header b-b bg-white hidden-print">
            ...
            <a href="{{ URL::to('seguridades/modulos/detalles/listar') . '/' . Crypt::encrypt($agrupador->id_subsistema) }}" class="btn btn-default btn-sm  pull-right" style="margin-right:5px; "><i class="icon-share-alt icon-black"></i> Cancelar</a>
            <p style="font-size: medium;"><i class="fa fa-unlock"></i> Seguridades / <strong> {!! $agrupador->descripcion !!} </strong> / Detalles / Crear</p>
        </header>
                        ...
                        <div class="panel-body">
                            <div class="bs-example form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('texto', Input::old('texto') ? Input::old('texto') : '', array('class' => 'form-control', 'data-required' => 'true', 'autocomplete' => 'off')) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('accion', Input::old('accion') ? Input::old('accion') : '', array('class' => 'form-control', 'autocomplete' => 'off')) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('controlador', Input::old('controlador') ? Input::old('controlador') : '', array('class' => 'form-control', 'data-required' => 'true', 'autocomplete' => 'off')) !!}
                                    </div>
                                </div>
