...
class GeneralesDistritosController extends Controller {
    ...
    public function __construct(repoDistritos $repo_main, repoZonas $repo_zonas, repoParroquias $repo_parroquias, repoCircuitos $repo_circuitos) {
    ...
    {
        return view('catalogos.gen_distritos.index');
    }
    ...
    public function buscar_registros_dt()
    {
        ...
        return \Datatable::query($this->repo_main->buscar_todos_dt())
            ...
            ->addColumn('commands',function($model)
            {
                ...
                . '<a href="' . url('catalogos/distritos/editar') .'/'. Crypt::encrypt($model->id_distrito) .'" class="btn btn-default btn-xs btn-mini "><i class="fa fa-pencil"></i></a>'
                . '<a href="' . url('catalogos/distritos/eliminar') .'/'. Crypt::encrypt($model->id_distrito) .'" class="btn btn-dark btn-xs btn-mini"><i class="fa fa-trash-o"></i></a>&nbsp;'
                . '</div>';
            })
            ->searchColumns(
    ...
    public function crear()
    {
        ...
        return view('catalogos.gen_distritos.crear', ['parroquias' => $parroquias, 'circuitos' => $circuitos, 'zonas' => $zonas]);
    }
    ...
    public function editar($id)
    {
        ...
        return view('catalogos.gen_distritos.editar', ['parroquias' => $parroquias, 'circuitos' => $circuitos, 'zonas' => $zonas])->with('registro', $registro);
    }
    ...
    public function eliminar($id)
    {
        ...
        return view('catalogos.gen_distritos.eliminar')->with('registro', $registro);
    }
