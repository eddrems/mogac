...
window.ParsleyConfig.i18n.es = $.extend(window.ParsleyConfig.i18n.es || {}, {
  ...
  type: {
    ...
    url:          "Este valor debe ser una URL válido.",
  ...
  minlength:      "Este valor es muy corto. La longitud mánima es de %s caracteres.",
  ...
  validarcedula:  "El número de cédula no es correcto"
});
